...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/01/13 13:53:34 by bokim             #+#    #+#              #
#    Updated: 2026/01/13 14:21:44 by bokim            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
class SecurePlant:
	...
	def set_height(self, tmp_height):
		if tmp_height >= 0:
			...
			print(f"\nInvalid operation attempted: height {tmp_height}cm [REJECTED]")
	...
	def set_age(self, tmp_age):
		if tmp_age >= 0:
			...
			print(f"Invalid operation attempted: height {tmp_age}cm [REJECTED]")
			print("Security: Negative height rejected")
	def get_age(self):
		return self.age
